...
public class TracerHeadWarning extends CustomComponent implements View, Listener{
	...
	@AutoGenerated
	private TracerTable warning_links;
	@AutoGenerated
	...
	private void getWarnings() {
		...
		warning_links.setCaption(l.size()+" Trackers older than "+dayInt+" days");
		
		
		warning_links.replaceAllItems(l);
	}
	...
	private VerticalLayout buildMainLayout() {
		...
		// warning_links
		warning_links = new TracerTable();
		warning_links.setWidth("100%");
		warning_links.setHeight("100%");
