...
public class TableExample extends CustomComponent implements Action.Handler,
    ...
    public TableExample() {
       ...
       // deselect.setStyleName(Button.STYLE_LINK);
        ...
        final CheckBox editmode =  new CheckBox("Edit ", new MethodProperty<Boolean>(source, "editable"));
        ...
        final CheckBox b =  new CheckBox("Modify saved creatures", new MethodProperty<Boolean>(saved, "editable"));
